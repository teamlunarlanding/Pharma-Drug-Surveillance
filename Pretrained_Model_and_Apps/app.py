...
if st.button('Make Prediction'):
    ...
    # One-hot encode `ndc9_code`
    try:
        # This will throw an error if the ndc9_code is not in the fitted categories
        ndc9_encoded = encoder.transform(pd.DataFrame({'ndc9': [cleaned_ndc9_code]}))
    except ValueError:
