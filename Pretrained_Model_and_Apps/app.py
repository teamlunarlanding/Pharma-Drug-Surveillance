...
# Streamlit app
st.title('Adverse Drug Event Risk Prediction System')

# Introduction text
st.markdown(
    "<h3 style='text-align: center;'>Welcome to the Adverse Drug Event Risk Prediction System. "
    "This system does not store any information from you and should not be used to make healthcare decisions "
    "without guidance from a healthcare professional. By using this tool, you confirm you understand this information.</h3>", 
...
with col1:
    ...
    weight = st.sidebar.number_input('Weight (kg)', min_value=0.0, max_value=200.0, value=70.0)
    unit_price = st.sidebar.number_input('Unit Price', min_value=0.0, max_value=1000.0, value=10.0)
...
with col2:
    ...
    st.subheader('Top 10 Reported Drugs by Serious Outcome')
