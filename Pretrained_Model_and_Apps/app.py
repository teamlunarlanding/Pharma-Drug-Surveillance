...
def predict(age, weight, sex_2, unit_price, ndc9_code):
    # Clean the NDC9 code
    ...
    input_data = np.concatenate(([age_scaled, weight_scaled, sex_2, price_scaled], one_hot_ndc9))
...
if st.button('Predict'):
    prediction = predict(age, weight, sex_2, unit_price, ndc9_code)
    if prediction == 0:
