...
with col2:
    ...
    st.subheader('Top 10 Reported Drugs by Seriousness Outcome (January 23, 2024 to April 23, 2024)')
    ...
    plt.ylabel('Drug Product', fontsize=18)
    #plt.title('Top 10 Reported Drugs by Serious Outcome')
    plt.legend(title='Serious Outcome', title_fontsize=18, fontsize=16)
